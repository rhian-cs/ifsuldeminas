 ...
 * @author 14171000102
 */
public class TelaAlterarDadosPaciente extends javax.swing.JFrame {

    /**
     * Creates new form TelaAlterarDadosAtendente
     */
    public TelaAlterarDadosPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Tela de Alterar Dados do Paciente");
        ...
        jLabel92.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/alterarDados.jpg"))); // NOI18N

        jLabel93.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel93.setForeground(new java.awt.Color(255, 255, 255));
        jLabel93.setText("Alterar Dados Paciente");
        ...
        listaDePessoas.setModel(TelaAlterarDadosPacienteController.selecionarUsuariosContratados());
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(painelDeRolagem, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(botaoAlterar, javax.swing.GroupLayout.DEFAULT_SIZE, 51, Short.MAX_VALUE)
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        //Verifica o ID e abre a tela para alterar dados já com os dados da pessoa preenchidos
        int indexFinal = selecao.indexOf(": ");
        String id = selecao.substring(0, indexFinal);
        
        PacienteDAO pacienteSelecionado = PacienteDAO.getPacientePorId(id);
        
        TelaAlterarDadosPacienteFormulario telaAtualizar = new TelaAlterarDadosPacienteFormulario(pacienteSelecionado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarDadosPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlterarDadosPaciente().setVisible(true);
            }
        });
    }
