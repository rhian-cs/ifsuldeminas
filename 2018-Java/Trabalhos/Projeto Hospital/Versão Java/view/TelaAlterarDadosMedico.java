 ...
 * @author 14171000102
 */
public class TelaAlterarDadosMedico extends javax.swing.JFrame {

    /**
     * Creates new form TelaAlterarDadosAtendente
     */
    public TelaAlterarDadosMedico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Tela de Alterar Dados do Médico");
        ...
        jLabel93.setText("Alterar Dados Médico");
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        MedicoDAO medicoSelecionado = MedicoDAO.getMedicoPorId(id);
        
        TelaAlterarDadosMedicoFormulario telaAtualizar = new TelaAlterarDadosMedicoFormulario(medicoSelecionado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarDadosMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlterarDadosMedico().setVisible(true);
            }
        });
    }
