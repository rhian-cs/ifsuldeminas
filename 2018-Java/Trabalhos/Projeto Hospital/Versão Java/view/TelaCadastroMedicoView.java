...
import DAO.buscaCEP;
import controller.TelaCadastroMedicoController;
...
public class TelaCadastroMedicoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Tela de Cadastro de Médico");
        ...
        jLabel13.setText("Cadastro de Médico");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
                    //Tira os espaços
                    resultado = new TelaCadastroMedicoController().acaoBotaoCadastrar(
                        nome.trim(),
                        email.trim(),
                        crm.trim(),
                        cep.trim(),
