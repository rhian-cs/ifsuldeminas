 ...
 * @author 14171000102
 */
public class TelaListarPacientesAView extends javax.swing.JFrame {

    /**
     * Creates new form TelaListarPacientesAView
     */
    public TelaListarPacientesAView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Lista de Pacientes");
        ...
        jLabel93.setText("Pacientes Cadastrados");
    ...
    private void botaoExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExibirActionPerformed
        ...
        PacienteDAO pac = PacienteDAO.getPacientePorId(id);

        String infoFuncionario = "Nome: " + pac.getNome() + "\n"
        + "E-mail: " + pac.getEmail() + "\n"
        + "CEP: " + pac.getCep() + "\n"
        + "Bairro: " + pac.getBairro() + "\n"
        + "Rua: " + pac.getRua() + "\n"
        + "Número: " + pac.getNumero() + "\n"
        + "Cidade: " + pac.getCidade() + "\n"
        + "Nacionalidade: " + pac.getNacionalidade() + "\n"
        + "CPF: " + pac.getCpf();

        JOptionPane.showMessageDialog(this, infoFuncionario, "Atendente " + pac.getId(), JOptionPane.PLAIN_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarPacientesAView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarPacientesAView().setVisible(true);
            }
        });
    }
