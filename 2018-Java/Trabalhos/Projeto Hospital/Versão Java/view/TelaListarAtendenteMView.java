 ...
 * @author 14171000102
 */
public class TelaListarAtendenteMView extends javax.swing.JFrame {

    /**
     * Creates new form TelaListarAtendenteMView
     */
    public TelaListarAtendenteMView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Médico - Lista de Atendentes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarAtendenteMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarAtendenteMView().setVisible(true);
            }
        });
    }
