...
import controller.TelaExcluirPacienteController;
 ...
 * @author VANESSA
 */
public class TelaExcluirPacienteView extends javax.swing.JFrame {

    /**
     * Creates new form TelaExcluirPacienteView
     */
    public TelaExcluirPacienteView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Tela para Excluir Pacientes");
        ...
        jLabel93.setText("Exclusão de Paciente");
        ...
        botaoExcluir.setFont(new java.awt.Font("Trebuchet MS", 1, 20)); // NOI18N
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        if (selecaoValida) {
            ...
            String exclusao = TelaExcluirPacienteController.botaoExcluir(id);
            if(exclusao.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Sucesso ao excluir este paciente.");

                TelaExcluirPacienteView telaAtualizada = new TelaExcluirPacienteView();
                telaAtualizada.setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, exclusao, "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExcluirPacienteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExcluirPacienteView().setVisible(true);
            }
        });
    }
