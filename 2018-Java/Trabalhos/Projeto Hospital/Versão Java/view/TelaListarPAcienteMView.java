 ...
 * @author 14171000102
 */
public class TelaListarPAcienteMView extends javax.swing.JFrame {

    /**
     * Creates new form TelaListarPAcienteMView
     */
    public TelaListarPAcienteMView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Médico - Lista de Pacientes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarPAcienteMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarPAcienteMView().setVisible(true);
            }
        });
    }
