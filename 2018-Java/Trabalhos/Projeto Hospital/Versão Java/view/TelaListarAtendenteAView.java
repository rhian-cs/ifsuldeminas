 ...
 * @author 14171000102
 */
public class TelaListarAtendenteAView extends javax.swing.JFrame {

    /**
     * Creates new form TelaListarAtendenteAView
     */
    public TelaListarAtendenteAView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atendente - Lista de Atendentes");
        ...
        jLabel93.setText("Atendentes Contratados");
    ...
    private void botaoExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExibirActionPerformed
        ...
        JOptionPane.showMessageDialog(this, infoFuncionario, "Atendente " + fnc.getId(), JOptionPane.PLAIN_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarAtendenteAView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarAtendenteAView().setVisible(true);
            }
        });
    }
