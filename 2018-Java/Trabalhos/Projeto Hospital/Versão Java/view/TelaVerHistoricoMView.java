 ...
 * @author VANESSA
 */
public class TelaVerHistoricoMView extends javax.swing.JFrame {

    /**
     * Creates new form TelaVerHistoricoMView
     */
    public TelaVerHistoricoMView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Médico - Visualizar Histórico de Pacientes");
    ...
    private void botaoVerHistoricoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoVerHistoricoActionPerformed
        ...
        TelaVerHistoricoIndividualMView telaAtualizar = new TelaVerHistoricoIndividualMView(pacienteSelecionado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerHistoricoMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerHistoricoMView().setVisible(true);
            }
        });
    }
