...
public class TelaDemitirAtendenteController {
    ...
    public static String botaoDemitir(String id) {
        ...
        AtendenteDAO fnc = AtendenteDAO.getAtendentePorId(id);
        
        String[] opcoes = {"Sim", "Não"};
        
		// Pergunta se o atendente deseja demitir este funcionário
        int resposta = JOptionPane.showOptionDialog(null,
            "Tem certeza de que deseja demitir este Atendente?",
            "Demissão de Atendente",
